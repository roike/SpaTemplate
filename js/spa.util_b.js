 ...
 *-----------------------------------------------------------------
 * Module for SPA Library Copyrighted by mmikowski@gmail.com
 * Released under the MIT license
 * -----history by ryuji.oike@gmail.com--------------------------
 * ver 0.1.0
 * not need jQuery
*/
...
spa.util_b = (function () {
  ...
  configMap.encode_noamp_map = _.extend(
  ...
  decodeHtml = function ( str ) {
    var dom = document.createElement('div').innerHTML = str || '';
